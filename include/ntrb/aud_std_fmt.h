...
/**
Loads and converts the WAV audio to standard audio format from WAV file.
\param[out] header
\param[out] datapoints Uninitialised ntrb_AudioDatapoints for output.
\param[in] filename

The function guarantees its resources and the datapoints argument will be freed if the return enum indicates an error.
*/
...
/**
Loads and converts the FLAC audio to standard audio format from FLAC file.
\param[out] header
\param[out] datapoints Uninitialised ntrb_AudioDatapoints for output.
\param[in] filename
...
/**
Loads and converts the audio to standard audio format from a file. It chooses how to handle each .filetype and does the loading and conversion for you.
