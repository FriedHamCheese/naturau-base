...
static void test__ntrb_memdebug_empty_realloc_callback(const void*, const void*){
}

static int test__ntrb_memdebug_unregistered_ptr_reallocs = 0;
static void test__ntrb_memdebug_realloc_count_unregistered_call(const void*, const void*){
